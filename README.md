...
| 02 | [日志](./02-logging/) | [slides.md](./02-logging/slides.md) · [deep-dive.md](./02-logging/deep-dive.md) | [slides.pptx](./02-logging/slides.pptx) | 新项目默认 `log/slog`；按读者分四层；应用只写 stdout，收集交给 agent |
